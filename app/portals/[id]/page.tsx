...
// Components for tabs
import { UpdatesTab, FilesTab, SettingsTab, Sidebar, type SidebarItem } from './components';
...
export default function PortalEditorPage() {
  ...
  const copyPublicLink = () => {
    if (project) {
      const link = `${window.location.origin}/public/${project.public_slug}`;
        ...
        <main className={styles.main}>
          <div className={styles.portalHeader}>
            ...
            <div className={styles.headerRight}>
              <Button variant="secondary" onClick={copyPublicLink} className={styles.copyButton}>
