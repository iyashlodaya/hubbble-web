        ...
        <div className={styles.main}>
           <div style={{ marginBottom: '60px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
             <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '10px' }}>
                <Skeleton width={300} height={60} className={`mb-4 ${theme === 'dark' ? 'skeleton-dark' : ''}`} />
                <Skeleton width={200} height={24} className={theme === 'dark' ? 'skeleton-dark' : ''} />
             </div>
           </div>
           
           <Skeleton width="100%" height={200} className={`mb-8 ${theme === 'dark' ? 'skeleton-dark' : ''}`} />
           
           <div className={styles.dashboardGrid}>
             <Skeleton height={140} className={theme === 'dark' ? 'skeleton-dark' : ''} />
             <Skeleton height={140} className={theme === 'dark' ? 'skeleton-dark' : ''} />
             <Skeleton height={140} className={theme === 'dark' ? 'skeleton-dark' : ''} />
           </div>
           ...
           <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 2fr) minmax(0, 1fr)', gap: '60px' }}>
              <div>
                <Skeleton width={150} height={32} className={`mb-6 ${theme === 'dark' ? 'skeleton-dark' : ''}`} />
                <Skeleton height={120} className={`mb-4 ${theme === 'dark' ? 'skeleton-dark' : ''}`} />
                <Skeleton height={120} className={theme === 'dark' ? 'skeleton-dark' : ''} />
              </div>
              <div>
                <Skeleton width={150} height={32} className={`mb-6 ${theme === 'dark' ? 'skeleton-dark' : ''}`} />
                <Skeleton height={200} className={theme === 'dark' ? 'skeleton-dark' : ''} />
              </div>
           </div>
        </div>
      </div>
      ...
      <main className={styles.main}>
        ...
        <header className={styles.header}>
          <div className={styles.headerLeft}>
            <Avatar 
                src={getAvatarSrc()} 
                emoji={avatarType === 'emoji' ? avatarValue : undefined}
